	...
	namespace XY2D_NAMESPACE {
		...
		public:
			...
			VkResult Initialize() {
				...
				VkDescriptorSetLayoutCreateInfo descriptorCreateInfo = xy2d_wrappers::defaultDescriptorCreateInfo;
				...
				VkPipelineLayoutCreateInfo pipelineLayoutInfo = xy2d_wrappers::defaultPipelineLayoutInfo;
				...
				for(size_t i = 0; i < shaderSources.size(); i++) {
					...
					VkShaderCreateInfoEXT shaderCreateInfo = xy2d_wrappers::defaultShaderCreateInfo;
